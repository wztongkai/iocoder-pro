package com.iocoder.yudao.commons.core.mapper;
...
import com.iocoder.yudao.commons.core.domain.PageParam;
import com.iocoder.yudao.commons.core.domain.PageResult;
import com.iocoder.yudao.commons.core.mybatis.MyBatisUtils;
...
public interface BaseMapperX<T> extends BaseMapper<T> {
    ...
    default T selectOne(SFunction<T, ?> field1, Object value1, SFunction<T, ?> field2, Object value2) {
        return this.selectOne(new LambdaQueryWrapper<T>().eq(field1, value1).eq(field2, value2));
    }
    ...
    default Long selectCount(SFunction<T, ?> field, Object value) {
        return this.selectCount(new LambdaQueryWrapper<T>().eq(field, value));
    }
    ...
    default List<T> selectList(SFunction<T, ?> field, Object value) {
        return this.selectList(new LambdaQueryWrapper<T>().eq(field, value));
    }

    default List<T> selectList(String field, Collection<?> values) {
        return this.selectList(new QueryWrapper<T>().in(field, values));
    }

    default List<T> selectList(SFunction<T, ?> field, Collection<?> values) {
        return this.selectList(new LambdaQueryWrapper<T>().in(field, values));
    }
