package com.iocoder.yudao.framework.config.security;


import com.iocoder.yudao.framework.config.properties.PermitAllUrlProperties;
import com.iocoder.yudao.framework.config.security.filter.JwtAuthenticationTokenFilter;
import com.iocoder.yudao.framework.config.security.web.handle.JwtAuthenticationEntryPoint;
import com.iocoder.yudao.framework.config.security.web.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .antMatchers("/login", "/register", "/captchaImage","/system/**/**").anonymous()
                // 静态资源，可匿名访问
